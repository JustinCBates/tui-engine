...
def test_feature_demos():
    ...
    demo_functions = [
        ...
        "demo_enhanced_text_features",
        "demo_number_features",
        "demo_integer_features",
        "demo_rating_features",
        "demo_select_features",
        "demo_checkbox_features",
        "demo_autocomplete_features",
        "demo_rawselect_features",
        "demo_confirm_features",
        "demo_email_validator_features",
        "demo_url_validator_features",
        "demo_date_validator_features",
        "demo_number_validator_features",
        "demo_range_validator_features",
        "demo_regex_validator_features",
        "demo_format_date_features",
        "demo_format_number_features",
        "demo_theming_features",
        "demo_progress_tracker_features",
        "demo_form_features",
        "demo_path_features",
        "demo_press_key_features",
        "demo_print_features",
    ]
...
def test_theming():
    ...
    try:
        ...
        custom_palette = ColorPalette(
            primary="#ff0000", secondary="#00ff00", success="#0000ff", error="#ffff00"
        )
