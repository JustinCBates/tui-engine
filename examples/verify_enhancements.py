...
def test_enhanced_features():
    ...
    try:
        from interactive_demo import get_code_sample, run_feature_demo, COMPONENT_CATALOG
    ...
    try:
        demo_functions = [
            'demo_text_features', 'demo_number_features', 'demo_select_features',
            'demo_email_validator_features', 'demo_theming_features'
        ]
