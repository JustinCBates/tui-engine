...
class TestCLIMockingPatterns:
    ...
    def test_namespace_mocking_pattern(self, monkeypatch):
        ...
        try:
            ...
            fake_questionary.text = lambda *a, **k: types.SimpleNamespace(
                ask=lambda: "test"
            )
            fake_questionary.select = lambda *a, **k: types.SimpleNamespace(
                ask=lambda: "option"
            )
...
class TestCLIErrorHandling:
    ...
    def test_cli_import_error_recovery(self):
        ...
        try:
            ...
            assert (
                "questionary_extended.cli" in str(e) or "questionary" in str(e).lower()
            )
